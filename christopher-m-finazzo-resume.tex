...
\begin{itemize}[nosep]
\item
  Shelved books, assisted patrons in finding books and information.
\item
  Maintained periodicals inventory on a weekly basis.
\end{itemize}
\companydetails{%
...
\end{raggedright}
\begin{center}
\textit{Updated on \VCDateISO -- \GITAbrHash}
\end{center}
\end{document}
